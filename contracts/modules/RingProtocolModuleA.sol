...
import { IRingProtocolModuleA } from "./../interfaces/modules/IRingProtocolModuleA.sol";


/**
 * @title RingProtocolModuleA
 ...
 */
contract RingProtocolModuleA is IRingProtocolModuleA {
    ...
    ***************************************/
    ...
    function executeRingProtocolModuleA(uint256 ethAmount) external payable override {
        ...
        ERC6551AccountLibrary.incrementState();
