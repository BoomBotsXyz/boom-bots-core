...
import { BoomBots, BoomBotAccount, ERC2535Module, ERC6551AccountModule, MulticallModule, ERC20HolderModule, ERC721HolderModule, FallbackModule, RevertModule, Test1Module, Test2Module, Test3Module, ModulePack100, ModulePack101, RingProtocolModuleB, BoomBotsFactory01, MockERC20, MockERC721, MockERC1155, DataStore, GasCollector } from "./../../typechain-types";
...
describe("modules/RingProtocolModuleB", function () {
  ...
  describe("setup", function () {
    ...
    it("can deploy modules", async function () {
      ...
      // RingProtocolModuleB
      ringProtocolModuleA = await deployContract(deployer, "RingProtocolModuleB", [BLAST_ADDRESS, owner.address]) as RingProtocolModuleB;
